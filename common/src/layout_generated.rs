...
pub const PHOTO_HEIGHT_MM_2UP: f32 = (A4_HEIGHT_MM - MARGIN_MM * 2.0 - PHOTO_GAP_MM) / 2.0;        // 133.50mm

// ============================================
// 変換係数
// ============================================

/// mm → pt変換 (1mm = 72/25.4 pt ≈ 2.8346456693pt)
...
/// ページサイズ（pt）
pub const PAGE_WIDTH_PT: f32 = A4_WIDTH_MM * MM_TO_PT;   // 595.28pt
pub const PAGE_HEIGHT_PT: f32 = A4_HEIGHT_MM * MM_TO_PT; // 841.89pt
...
pub const PHOTO_HEIGHT_PT_3UP: f32 = PHOTO_HEIGHT_MM_3UP * MM_TO_PT; // 242.8pt
pub const PHOTO_HEIGHT_PT_2UP: f32 = PHOTO_HEIGHT_MM_2UP * MM_TO_PT; // 378.4pt

/// 情報パネル幅（pt）
pub const INFO_WIDTH_PT: f32 = INFO_WIDTH_MM * MM_TO_PT;         // 188.5pt

/// ブロック高さ（pt）
pub const BLOCK_HEIGHT_3UP_PT: f32 = PHOTO_HEIGHT_PT_3UP + GAP_PT; // 271.18pt
pub const BLOCK_HEIGHT_2UP_PT: f32 = PHOTO_HEIGHT_PT_2UP * 1.5;    // 567.64pt
